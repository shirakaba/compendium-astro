export function DarkModeToggle() {
  return (
    <button
      className="border-0 bg-none bg-[#86CAF4] dark:bg-[#0E1039] rounded-full p-[5px] transition-colors"
      onClick={() => {
    ...
    >
      <svg width="24px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path
          className="fill-[#F9F299] dark:fill-transparent transition-colors"
          fillRule="evenodd"
        ...
        />
        <path
          className="fill-transparent dark:fill-[#EFFCFC] transition-colors"
          fillRule="evenodd"
